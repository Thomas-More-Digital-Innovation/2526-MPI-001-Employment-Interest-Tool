<div
        ...
        <div class="space-y-6">
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        <flux:select wire:model.defer="form.organisation_id" :label="__('Organisation')" required>
    ...
    <flux:modal
        ...
        <div class="space-y-6">
            ...
            <flux:text class="text-sm text-gray-700">{{ __('admins.delete_confirm_text') ?? 'Are you sure you want to remove admin role from this user?' }}</flux:text>
